...
if (!function_exists('uploaded_asset')) {
    function uploaded_asset($id)
    {
        if (($asset = \App\Models\Upload::find($id)) != null) {
            ...
            // Add public/uploads/all/ prefix if not present
            $file_name = $asset->file_name;
            if (!str_starts_with($file_name, 'public/uploads/')) {
                if (!str_starts_with($file_name, 'uploads/')) {
                    $file_name = 'public/uploads/all/' . $file_name;
                } else {
        ...
        return static_asset('public/assets/img/placeholder.jpg');
    }
}
