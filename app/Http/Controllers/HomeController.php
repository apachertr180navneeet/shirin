...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $perfumebyparvazproduct = filter_products(Product::where(function($q) {
            $q->where('category_id', "16")->orWhereHas('categories', function($q2) {
                $q2->where('category_id', "16");
            });
        })->where('published', 1)->orderBy('num_of_sale', 'desc'))->limit(8)->get();
        $goldattarbottelproduct = filter_products(Product::where('category_id', "13")->where('published', 1)->orderBy('num_of_sale', 'desc'))->limit(8)->get();
        ...
        return view('frontend.index', compact('featured_categories', 'todays_deal_products', 'newest_products','blogs','top_sale_products','insta_reels', 'customer_showcase','products_with_video','perfumebyparvazproduct','goldattarbottelproduct','perfumeproduct','atherproduct'));
