    ...
    public function getList(Request $request)
    {
        ...
        if ($list == "online" || $list == "both") {
            if (get_setting('paypal_payment') == 1) {
                ...
                $payment_type['image'] = static_asset('public/assets/img/cards/paypal.png');
            ...
            if (get_setting('stripe_payment') == 1) {
                ...
                $payment_type['image'] = static_asset('public/assets/img/cards/stripe.png');
            ...
            if (get_setting('razorpay') == 1) {
                ...
                $payment_type['image'] = static_asset('public/assets/img/cards/rozarpay.png');
            ...
            if (get_setting('paystack') == 1) {
                ...
                $payment_type['image'] = static_asset('public/assets/img/cards/paystack.png');
            ...
            if (get_setting('iyzico') == 1) {
                ...
                $payment_type['image'] = static_asset('public/assets/img/cards/iyzico.png');
            ...
            if (get_setting('bkash') == 1) {
                ...
                $payment_type['image'] = static_asset('public/assets/img/cards/bkash.png');
            ...
            if (get_setting('nagad') == 1) {
                ...
                $payment_type['image'] = static_asset('public/assets/img/cards/nagad.png');
            ...
            if (get_setting('sslcommerz_payment') == 1) {
                ...
                $payment_type['image'] = static_asset('public/assets/img/cards/sslcommerz.png');
            ...
            if (addon_is_activated('african_pg') && get_setting('flutterwave') == 1) {
                ...
                $payment_type['image'] = static_asset('public/assets/img/cards/flutterwave.png');
            ...
            if (addon_is_activated('paytm')) {
                ...
                $payment_type['image'] = static_asset('public/assets/img/cards/paytm.jpg');
        ...
        if ($mode != 'wallet' && $mode != 'seller_package' && $list != "offline") {
            if (get_setting('wallet_system') == 1) {
                ...
                $payment_type['image'] = static_asset('public/assets/img/cards/wallet.png');
            ...
            if (get_setting('cash_payment') == 1  && !$haveDigitalProduct && !$cash_on_delivery) {
                ...
                $payment_type['image'] = static_asset('public/assets/img/cards/cod.png');
