...
route::get('product-details-demo', function(){
    return view('frontend.product_details.product_details-demo');
  });
...
Route::controller(ContactController::class)->group(function () {
    Route::post('contact-store', 'store')->name('contactus.store');
});
...
Route::controller(HomeController::class)->group(function () {
    ...
    Route::get('/newlogin', 'newlogin')->name('new.login');

    Route::post('/send-otp','sendOtp')->name('otp.send');
    Route::post('/verify-otp', 'verifyOtp')->name('otp.verify');
    Route::post('/cart-send-otp', 'sendOtpcart')->name('send.otp');
    Route::post('/cart-verify-otp', 'verifyOtpcart')->name('verify.otp');
});
...
Route::controller(SearchController::class)->group(function () {
    ...
    Route::get('/product-listing', 'index');
...
Route::group(['middleware' => ['user', 'unbanned']], function() {
  ...
  Route::get('gallery', [GalleryController::class, 'frontend_gallery'])->name('gallery');
