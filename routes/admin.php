...
use App\Http\Controllers\CustomerShowcaseController;
...
Route::controller(ContactController::class)->group(function () {
    Route::get('contact-list','index')->name('contact.index');
});
...
Route::resource('adminslider', App\Http\Controllers\SliderController::class);
   
Route::get('/slider/destroy/{id}', 'App\Http\Controllers\SliderController@destroy')->name('slider.destroy');
Route::get('/bottomsection', 'App\Http\Controllers\SliderController@bottomsection');

Route::Post('/bottomsectionstore', 'App\Http\Controllers\SliderController@bottomsectionstore');

Route::resource('admingallery', App\Http\Controllers\GalleryController::class);
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    // InstagramReels
    Route::resource('insta-reels', InstagramReelsController::class);
    Route::post('/insta-reels/change-status', [InstagramReelsController::class, 'change_status'])->name('instagram-reels.change-status');
    Route::get('/insta-reels/destroy/{id}', [InstagramReelsController::class, 'destroy'])->name('insta-reels.destroy');

    // customer showcase 
    Route::resource('customer_showcase', CustomerShowcaseController::class);
    Route::post('/customer-showcase/change-status', [CustomerShowcaseController::class, 'change_status'])->name('customer-showcase.change-status');
    Route::get('/customer-showcase/destroy/{id}', [CustomerShowcaseController::class, 'destroy'])->name('customer-showcase.destroy');

    // testimonial
    Route::resource('testimonial', TestimonialController::class);
    Route::post('/testimonial/change-status', [TestimonialController::class, 'change_status'])->name('testimonials.change-status');
    Route::get('/testimonial/destroy/{id}', [TestimonialController::class, 'destroy'])->name('testimonials.destroy');

     // Add Review
    Route::resource('add_reviews', AddReviewController::class);

    Route::controller(AddReviewController::class)->group(function () {
        Route::get('/add_reviews/edit/{id}', 'edit')->name('add_reviews.edit');
        Route::get('/add_reviews/create', 'create')->name('add_reviews.create');
        Route::get('/add_reviews/destroy/{id}', 'destroy')->name('add_reviews.destroy');
        Route::post('/add_reviews/published', 'updatePublished')->name('add_reviews.published');
    });
});
