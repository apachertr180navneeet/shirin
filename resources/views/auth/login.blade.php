                ...
                <div class="card text-left">
                    <div class="card-body">
                        <div class="mb-5 text-center">
                            ...
                            @else
                                <img src="{{ static_asset('public/assets/img/logo.png') }}" class="mw-100 mb-4" height="40">
                            @endif
                        ...
                        <div class="mt-3">
                            {{translate('Create an account')}} ? <a href="{{route('register')}}" class="btn-link mar-rgt text-bold">{{translate('Register')}}</a>
                        </div>
