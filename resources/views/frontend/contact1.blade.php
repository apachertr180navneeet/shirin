...
@section('content')
    ...
    <main class="main__content_wrapper">
            ...
            <div class="container">
                ...
                <div class="main__contact--area position__relative">
                    ...
                    <div class="contact__form">
                        ...
                        <div class="" style="background-color:#80ff00; text-align:center"> @if(session()->has('success')) {{session()->get('success')}} @endif</div>
                        <form class="contact__form--inner" action="{{route('contactus.store')}}" method="post" >
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="contact__form--list mb-20">
                                        ...
                                        <input class="contact__form--input" name="firstname" id="input1" placeholder="Your First Name" type="text" value="{{old('firstname')}}"">
                                        <span class="error_msg text-danger" id="name_error">{{$errors->first('firstname')}}</span>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="contact__form--list mb-20">
                                        <label class="contact__form--label" for="input2">Last Name <span class="contact__form--label__star">*</span></label>
                                        <input class="contact__form--input" value="{{old('firstname')}}" name="lastname" id="input2" placeholder="Your Last Name" type="text">
                                        <span class="error_msg text-danger" id="name_error">{{$errors->first('lastname')}}</span>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="contact__form--list mb-20">
                                        ...
                                        <span class="error_msg text-danger" id="name_error">{{$errors->first('number')}}</span>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="contact__form--list mb-20">
                                        <label class="contact__form--label" for="input4">Email <span class="contact__form--label__star">*</span></label>
                                        <input class="contact__form--input" value="{{old('email')}}" name="email" id="input4" placeholder="Email" type="email">
                                        <span class="error_msg text-danger" id="name_error">{{$errors->first('email')}}</span>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="contact__form--list mb-15">
                                        <label class="contact__form--label"  for="input5">Write Your Message </label>
                                        <textarea class="contact__form--textarea"  value="{{old('message')}}" name="message" id="input5" placeholder="Write Your Message"></textarea>
                                    </div>
                                </div>
                            </div>
                            <button class="contact__form--btn primary__btn" type="submit" style="background-color:black;">Submit Now</button>  
                        </form>
                    </div>
                    <div class="contact__info border-radius-5" style="background-color:black;">
                        <div class="contact__info--items">
                            ...
                            <div class="contact__info--items__inner d-flex">
                                ...
                                <div class="contact__info--content">
                                    <p class="contact__info--content__desc text-white">Change the design through a range <br> <a href="tel:+01234-567890">+19 9772996769</a> 
                        ...
                        <div class="contact__info--items">
                            ...
                            <div class="contact__info--items__inner d-flex">
                                ...
                                <div class="contact__info--content">
                                    <p class="contact__info-- text-white" style="padding-top:4%"> <a href="mailto:Sainilaxmikant007@gmail.com">Sainilaxmikant007@gmail.com</a> <br> 
                        ...
                        <div class="contact__info--items">
                            ...
                            <div class="contact__info--items__inner d-flex">
                                ...
                                <div class="contact__info--content">
                                    <p class="contact__info--content__desc text-white">Balaji College Road, P.N. 7, Ground Floor Tiwari Bhawan,Ganesh Nagar 1st, Benar Rd, Sitwali Phatak, Jaipur, Rajasthan 302013</p> 
                                </div>
                            </div>
                        </div>
                        <div class="contact__info--items">
        ...
        <div class="contact__map--area section--padding pt-0">
            <iframe class="contact__map--iframe" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d222.20612957654706!2d75.7439600687433!3d26.989119209286912!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x396db291455ef021%3A0xa37a9e7d762d3e8f!2sBhardwaj%20Electricals%20And%20Sanitary!5e0!3m2!1sen!2sin!4v1709555526172!5m2!1sen!2sin" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
            <!--<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d222.20612957654706!2d75.7439600687433!3d26.989119209286912!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x396db291455ef021%3A0xa37a9e7d762d3e8f!2sBhardwaj%20Electricals%20And%20Sanitary!5e0!3m2!1sen!2sin!4v1709555526172!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>-->
        </div>
                ...
                <div class="shipping__section2--inner shipping__style3--inner d-flex justify-content-between">
                    <div class="shipping__items2 d-flex align-items-center">
                        <div class="shipping__items2--icon">
                            <img src="{{static_asset('public/assets/webtheme/assets/img/other/shipping1.png')}}" alt="">
                        </div>
                    ...
                    <div class="shipping__items2 d-flex align-items-center">
                        <div class="shipping__items2--icon">
                            <img src="{{static_asset('public/assets/webtheme/assets/img/other/shipping2.png')}}" alt="">
                        </div>
                        <div class="shipping__items2--content">
                    ...
                    <div class="shipping__items2 d-flex align-items-center">
                        <div class="shipping__items2--icon">
                            <img src="{{static_asset('public/assets/webtheme/assets/img/other/shipping3.png')}}" alt="">
                        </div>
                        <div class="shipping__items2--content">
                    ...
                    <div class="shipping__items2 d-flex align-items-center">
                        <div class="shipping__items2--icon">
                            <img src="{{static_asset('public/assets/webtheme/assets/img/other/shipping4.png')}}" alt="">
                        </div>
                        <div class="shipping__items2--content">
