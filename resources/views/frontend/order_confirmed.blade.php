            ...
            <div class="row">
                <div class="col-xl-8 mx-auto">
                    <div class="row gutters-5 sm-gutters-10">
                        ...
                        <div class="col done">
                            <div class="text-center border-bottom-6px p-1 text-success single__widget widget__bg">
                                <i class="la-3x mb-2 las la-credit-card payment-icon"></i>
                                <h3 class="fs-14 fw-600 d-none d-lg-block payment-title">{{ translate('3. Payment') }}</h3>
                            </div>
                        </div>
                        <div class="col active">
                            <div class="text-center border-bottom-6px p-1 text-primary single__widget widget__bg">
                                ...
                                <h3 class="fs-14 fw-600 d-none d-lg-block payment-title">{{ translate('4. Confirmation') }}
                                </h3>
                            </div>
                        </div>
                    </div>
