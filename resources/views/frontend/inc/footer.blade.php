        ...
        <div class="mt-3 mb-4">
            <a href="{{ route('home') }}" class="d-block">
                @if(get_setting('footer_logo') != null)
                    <img class="lazyload" src="{{ static_asset('public/assets/img/placeholder-rect.jpg') }}" data-src="{{ uploaded_asset(get_setting('footer_logo')) }}" alt="{{ env('APP_NAME') }}" height="44">
                @else
                    <img class="lazyload" src="{{ static_asset('public/assets/img/placeholder-rect.jpg') }}" data-src="{{ static_asset('public/assets/img/logo.png') }}" alt="{{ env('APP_NAME') }}" height="44">
                @endif
            </a>
        </div>
        <div class="row">
                    ...
                    <div class="d-flex mt-3">
                        <div class="">
                            <a href="{{ get_setting('play_store_link') }}" target="_blank" class="mr-2 mb-2 overflow-hidden hov-scale-img">
                                <img class="lazyload has-transition" src="{{ static_asset('public/assets/img/placeholder-rect.jpg') }}" data-src="{{ static_asset('public/assets/img/play.png') }}" alt="{{ env('APP_NAME') }}" height="44">
                            </a>
                        </div>
                        <div class="">
                            <a href="{{ get_setting('app_store_link') }}" target="_blank" class="overflow-hidden hov-scale-img">
                                <img class="lazyload has-transition" src="{{ static_asset('public/assets/img/placeholder-rect.jpg') }}" data-src="{{ static_asset('public/assets/img/app.png') }}" alt="{{ env('APP_NAME') }}" height="44">
                            </a>
                        </div>
                    </div>
                @endif
                ...
                @if(isAdmin())
                    <a href="{{ route('admin.dashboard') }}" class="text-secondary d-block text-center pb-2 pt-3">
                        <span class="d-block mx-auto">
                            ...
                            @else
                                <img src="{{ static_asset('public/assets/img/avatar-place.png') }}" class="rounded-circle size-20px">
                            @endif
                        </span>
