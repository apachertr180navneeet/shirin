                        ...
                        <div class="blog__details--wrapper">
                            <div class="entry__blog">
                                <div class="blog__post--header mb-30">
                                    ...
                                    <div class="blog__social--media d-flex align-items-center">
                                        ...
                                        <div class="post__article--content">
                                            <span class="meta__deta">{{ date('M d, Y',strtotime($blog->created_at)) }}</span>
                                        </div>
                                ...
                                <div class="blog__thumbnail mb-30">
                                    <img class="blog__thumbnail--img border-radius-10"  src="{{ uploaded_asset($blog->banner) }}" alt="blog-img">
                                </div>
                                    ...
                                    <div class="post__article--items d-flex align-items-center">
                                        <div class="post__article--thumbnail">
                                            <a class="display-block" href="{{ url("blog").'/'. $recent_blog->slug }}">
                                                <img class="post__article--thumbnail__img" src="{{ uploaded_asset($recent_blog->banner) }}" alt="article-img">
                                            </a>
                                        </div>
                                        <div class="post__article--content">
                                            <h3 class="post__article--content__title"><a href="{{ url("blog").'/'. $recent_blog->slug }}">{{ $recent_blog->title }} </a></h3>
