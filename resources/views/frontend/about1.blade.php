                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="about__thumb d-flex">
                            <div class="about__thumb--items">
                                <img class="about__thumb--img border-radius-5 display-block" src="{{static_asset('public/assets/webtheme/assets/img/other/male-athlete-doing-fitness-training-workout-outside-gym.jpg')}}" alt="about-thumb">
                            </div>
                            <div class="about__thumb--items position__relative">
                                <img class="about__thumb--img border-radius-5 display-block" src="{{static_asset('public/assets/webtheme/assets/img/other/sporty-man-urban-environment.jpg')}}" alt="about-thumb">
                                <div class="banner__bideo--play about__thumb--play">
                                    <a class="banner__bideo-- about__thumb--play__icon glightbox" href="https://vimeo.com/115041822" data-gallery="video">
                    ...
                    <div class="col-lg-6">
                        <div class="about__content">
                            ...
                            <p class="about__content--desc mb-20">Welcome to Viksun, where we celebrate the essence of everyday life and the magic of endless possibilities. Our philosophy revolves around you and only you, embodying the spirit of self-confidence, style, and carefree attitude. At Viksun, we blend western fashion-forward styles with impeccable quality and unbeatable value, creating a truly unique experience for the style-conscious millennial.

.<p>
                            <p class="about__content--desc mb-25">We start in 2016, we embarked on an exciting adventure into the Indian market with the opening of our first store in Jaipur.

Track-Suit is at the heart of Viksun, and we take pride in revolutionizing the world with our runway-inspired, trend-driven collection of Track-Suit wear. Our designs epitomize the Track-Suit attitude, offering a blend of style, comfort, and individuality.</p>
                        ...
                        <div class="counterup__banner--inner position__relative d-flex align-items-center justify-content-between">
                            <div class="counterup__banner--items text-center">
                                <h2 class="counterup__banner--items__text text-white">YEARS OF <br>
                                    FOUNDATION</h2>
                                <span class="counterup__banner--items__number js-counter text-white" data-count="50">8</span>
                            </div>
                            <div class="counterup__banner--items text-center">
                            ...
                            <div class="counterup__banner--items text-center">
                                <h2 class="counterup__banner--items__text text-white">MONTHLY <br>
                                    ORDERS</h2>
                                <span class="counterup__banner--items__number js-counter text-white" data-count="70">200</span>
                            </div>
                        </div>
                    </div>
                </div>
