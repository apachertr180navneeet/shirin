        ...
        <div class="modal-content">
            ...
            <div class="modal-header d-block py-4">
                <div class="d-flex justify-content-center">
                    <span class="avatar avatar-md mb-2 mt-2">
                        ...
                        @else
                            <img src="{{ static_asset('public/assets/img/avatar-place.png') }}" class="image rounded-circle m-auto"
                                onerror="this.onerror=null;this.src='{{ static_asset('public/assets/img/avatar-place.png') }}';">
                        @endif
                    </span>
                </div>
            ...
            <div class="modal-body pt-3 pb-5 px-xl-5">
                ...
                <div class="row bg-soft-warning py-2 mb-2 ml-0 mr-0 border-left border-width-2 border-danger">
                    <div class="col-1">
                        <img src="{{ static_asset('public/assets/img/warning.png') }}" class="h-20px">
                    </div>
                    <div class="col">
