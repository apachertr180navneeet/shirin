                                ...
                                <thead class="compare__table--header">
                                    <tr class="compare__table--items">
                                        <td class="compare__table--items__child">
                                            ...
                                            <h3 class="compare__product--title h4">Rings</h3>
                                            <img class="compare__product--thumb display-block" src="{{route('webtheme/user/assets/img/Gorga Jewels/GJR01R1.jpg')}}" alt="compare-image">
                                        </td>
                                        <td class="compare__table--items__child">
                                            <button type="button" aria-label="compare remove btn" class="compare__remove">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24.105" height="24.732" viewBox="0 0 512 512"><path fill="currentColor" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M368 368L144 144M368 144L144 368"></path></svg>
                                            </button>
                                            <h3 class="compare__product--title h4">bracelets</h3>
                                            <img class="compare__product--thumb display-block" src="assets/img/bracelet zip/GJBR01R2.jpg" alt="compare-image">
                                        </td>
                                        <td class="compare__table--items__child">
                                            <button type="button" aria-label="compare remove btn" class="compare__remove">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24.105" height="24.732" viewBox="0 0 512 512"><path fill="currentColor" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M368 368L144 144M368 144L144 368"></path></svg>
                                            </button>
                                            <h3 class="compare__product--title h4">Earrings</h3>
                                            <img class="compare__product--thumb display-block" src="assets/img/earrings zip/GJER01R3.jpg" alt="compare-image">
                                        </td>
                                        <td class="compare__table--items__child">
                                            <button type="button" aria-label="compare remove btn" class="compare__remove">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24.105" height="24.732" viewBox="0 0 512 512"><path fill="currentColor" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M368 368L144 144M368 144L144 368"></path></svg>
                                            </button>
                                            <h3 class="compare__product--title h4">Necklaces</h3>
                                            <img class="compare__product--thumb display-block" src="assets/img/pendants zip/GJP02R1.jpg" alt="compare-image">
                                        </td>
                                        <td class="compare__table--items__child">
                                            <button type="button" aria-label="compare remove btn" class="compare__remove">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24.105" height="24.732" viewBox="0 0 512 512"><path fill="currentColor" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M368 368L144 144M368 144L144 368"></path></svg>
                                            ...
                                            <h3 class="compare__product--title h4">Rings</h3>
                                            <img class="compare__product--thumb display-block" src="assets/img/Gorga Jewels/GJR02R2.jpg" alt="compare-image">
                                        </td>
                                    </tr>
                                </thead>
...
<!-- Mirrored from risingtheme.com/html/demo-becute/becute/compare.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Jul 2024 12:06:48 GMT -->
<!-- </html> -->
