                ...
                <div class="row">
                    ...
                    @endphp
                                ...
                                <div class="product__card--content text-center">
                                    ...
                                    <h3 class="product__card--title"><a href="product-details.php">{{  $sp->getTranslation('name')  }}</a></h3>
                                    <div class="product__card--price">
                                        <span class="current__price">{{ home_discounted_base_price($sp) }}</span>
                                        <span class="old__price"> {{ single_price($sp->starting_bid) }}</span> 
                                    </div>
                                </div>
                            </article>
                                            </div>@endforeach
