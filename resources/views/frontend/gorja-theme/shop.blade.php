@extends('frontend.gorja-layouts.app')
@section('content')
            ...
            <div class="container">
                ...
                <div class="shop__collection--column5 swiper">
                    ...
                    @foreach(App\Models\Category::orderBy('id','desc')->get() as $category)
                        <div class="swiper-slide">
                            <div class="shop__collection--card text-center">
                                <a class="shop__collection--link" href="shop.php">
                                    <img class="shop__collection--img" src="{{ uploaded_asset($category->banner) }}" alt="icon-img">
                                    <h3 class="shop__collection--title mb-0">{{  $category->getTranslation('name') }}</h3>
                                </a>
                            </div>
                        </div>@endforeach
                        <!--<div class="swiper-slide">-->
                        <!--    <div class="shop__collection--card text-center">-->
                        <!--        <a class="shop__collection--link" href="shop.php">-->
                        <!--            <img class="shop__collection--img" src="{{static_asset('public/assets/webtheme/user/assets/img/bracelet zip/GJBR01R2.jpg')}}" alt="icon-img">-->
                        ...
                        <!--    <div class="shop__collection--card text-center">-->
                        <!--        <a class="shop__collection--link" href="shop.php">-->
                        <!--            <img class="shop__collection--img" src="{{static_asset('public/assets/webtheme/user/assets/img/earrings zip/GJER01R3.jpg')}}" alt="icon-img">-->
                        ...
                        <!--    <div class="shop__collection--card text-center">-->
                        <!--        <a class="shop__collection--link" href="shop.php">-->
                        <!--            <img class="shop__collection--img" src="{{static_asset('public/assets/webtheme/user/assets/img/Gorga Jewels/GJR03R1.jpg')}}" alt="icon-img">-->
                        ...
                        <!--    <div class="shop__collection--card text-center">-->
                        <!--        <a class="shop__collection--link" href="shop.php">-->
                        <!--            <img class="shop__collection--img" src="{{static_asset('public/assets/webtheme/user/assets/img/earrings zip/GJER12R2.jpg')}}" alt="icon-img">-->
                        <!--            <h3 class="shop__collection--title mb-0">Earrings</h3>-->
                        <!--        </a>-->
                        <!--    </div>-->
                        <!--</div>-->
                        ...
                        <div class="shop__sidebar--widget widget__area d-none d-lg-block">
                                ...
                                <ul class="widget__categories--menu">
                                    <li class="widget__categories--menu__list">
                                        <label class="widget__categories--menu__label d-flex align-items-center">
                                            <img class="widget__categories--menu__img" src="assets/img/pendants zip/GJP01R1.jpg" alt="categories-img">
                                            <span class="widget__categories--menu__text">Necklaces</span>
                                        ...
                                        <ul class="widget__categories--sub__menu">
                                            <li class="widget__categories--sub__menu--list">
                                                <a class="widget__categories--sub__menu--link d-flex align-items-center" href="shop.php">
                                                    <img class="widget__categories--sub__menu--img" src="assets/img/pendants zip/GJP01R2.jpg" alt="categories-img">
                                                    <span class="widget__categories--sub__menu--text">Necklaces</span>
                                                </a>
                                            </li>
                                            <li class="widget__categories--sub__menu--list">
                                                <a class="widget__categories--sub__menu--link d-flex align-items-center" href="shop.php">
                                                    <img class="widget__categories--sub__menu--img" src="assets/img/pendants zip/GJP01R3.jpg" alt="categories-img">
                                                    <span class="widget__categories--sub__menu--text">Necklaces </span>
                                                </a>
                                            </li>
                                            <!-- <li class="widget__categories--sub__menu--list">
                                    ...
                                    <li class="widget__categories--menu__list">
                                        <label class="widget__categories--menu__label d-flex align-items-center">
                                            <img class="widget__categories--menu__img" src="assets/img/bracelet zip/GJBR01R2.jpg" alt="categories-img">
                                            <span class="widget__categories--menu__text">Bracelets</span>
                                            <svg class="widget__categories--menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12.355" height="8.394" >
                                                <path  d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z" transform="translate(-6 -8.59)" fill="currentColor"></path>
                                            </svg>
                                        </label>
                                        <ul class="widget__categories--sub__menu">
                                            <li class="widget__categories--sub__menu--list">
                                                <a class="widget__categories--sub__menu--link d-flex align-items-center" href="shop.php">
                                                    <img class="widget__categories--sub__menu--img" src="assets/img/bracelet zip/GJBR01R1.jpg" alt="categories-img">
                                                    <span class="widget__categories--sub__menu--text">Bracelets</span>
                                                </a>
                                            </li>
                                            <li class="widget__categories--sub__menu--list">
                                                <a class="widget__categories--sub__menu--link d-flex align-items-center" href="shop.php">
                                                    <img class="widget__categories--sub__menu--img" src="assets/img/bracelet zip/GJBR01R3.jpg" alt="categories-img">
                                                    <span class="widget__categories--sub__menu--text">Bracelets </span>
                                                </a>
                                            </li>
                                            <!-- <li class="widget__categories--sub__menu--list">
                                    ...
                                    <li class="widget__categories--menu__list">
                                        <label class="widget__categories--menu__label d-flex align-items-center">
                                            <img class="widget__categories--menu__img" src="assets\img\earrings zip\GJER01R3.jpg" alt="categories-img">
                                            <span class="widget__categories--menu__text">Earrings</span>
                                            <svg class="widget__categories--menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12.355" height="8.394">
                                                <path  d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z" transform="translate(-6 -8.59)" fill="currentColor"></path>
                                            </svg>
                                        </label>
                                        <ul class="widget__categories--sub__menu">
                                            <li class="widget__categories--sub__menu--list">
                                                <a class="widget__categories--sub__menu--link d-flex align-items-center" href="shop.php">
                                                    <img class="widget__categories--sub__menu--img" src="assets\img\earrings zip\GJER01R2.jpg" alt="categories-img">
                                                    <span class="widget__categories--sub__menu--text">Earrings</span>
                                                </a>
                                            </li>
                                            <li class="widget__categories--sub__menu--list">
                                                <a class="widget__categories--sub__menu--link d-flex align-items-center" href="shop.php">
                                                    <img class="widget__categories--sub__menu--img" src="assets\img\earrings zip\GJER01R1.jpg" alt="categories-img">
                                                    <span class="widget__categories--sub__menu--text">Earrings </span>
                                                </a>
                                            </li>
                                            <!-- <li class="widget__categories--sub__menu--list">
                                    ...
                                    <li class="widget__categories--menu__list">
                                        <label class="widget__categories--menu__label d-flex align-items-center">
                                            <img class="widget__categories--menu__img" src="assets/img/Gorga Jewels/GJR03R1.jpg" alt="categories-img">
                                            <span class="widget__categories--menu__text">Rings</span>
                                            <svg class="widget__categories--menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12.355" height="8.394">
                                                <path  d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z" transform="translate(-6 -8.59)" fill="currentColor"></path>
                                            </svg>
                                        </label>
                                        <ul class="widget__categories--sub__menu">
                                            <li class="widget__categories--sub__menu--list">
                                                <a class="widget__categories--sub__menu--link d-flex align-items-center" href="shop.php">
                                                    <img class="widget__categories--sub__menu--img" src="assets/img/Gorga Jewels/GJR03R2.jpg" alt="categories-img">
                                                    <span class="widget__categories--sub__menu--text">Rings</span>
                                                </a>
                                            </li>
                                            <li class="widget__categories--sub__menu--list">
                                                <a class="widget__categories--sub__menu--link d-flex align-items-center" href="shop.php">
                                                    <img class="widget__categories--sub__menu--img" src="assets/img/Gorga Jewels/GJR03R3.jpg" alt="categories-img">
                                                    <span class="widget__categories--sub__menu--text">Rings </span>
                                                </a>
                                            </li>
                                            <!-- <li class="widget__categories--sub__menu--list">
                                    ...
                                    <!-- <li class="widget__categories--menu__list">
                                        <label class="widget__categories--menu__label d-flex align-items-center">
                                            <img class="widget__categories--menu__img" src="assets/img/Gorga Jewels/GJR11R2.jpg" alt="categories-img">
                                            <span class="widget__categories--menu__text">Solid Silver Ring</span>
                                            <svg class="widget__categories--menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12.355" height="8.394">
                                                <path  d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z" transform="translate(-6 -8.59)" fill="currentColor"></path>
                                            </svg>
                                        </label>
                                        <ul class="widget__categories--sub__menu">
                                            <li class="widget__categories--sub__menu--list">
                                                <a class="widget__categories--sub__menu--link d-flex align-items-center" href="shop.php">
                                                    <img class="widget__categories--sub__menu--img" src="assets/img/Gorga Jewels/GJR11R1.jpg" alt="categories-img">
                                                    <span class="widget__categories--sub__menu--text">Solid Gold</span>
                                                </a>
                                            </li>
                                            <li class="widget__categories--sub__menu--list">
                                                <a class="widget__categories--sub__menu--link d-flex align-items-center" href="shop.php">
                                                    <img class="widget__categories--sub__menu--img" src="assets/img/Gorga Jewels/GJR11R3.jpg" alt="categories-img">
                                                    <span class="widget__categories--sub__menu--text">Pink Gold Rings </span>
                                                </a>
                                            </li>
                                            <li class="widget__categories--sub__menu--list">
                                                <a class="widget__categories--sub__menu--link d-flex align-items-center" href="shop.php">
                            ...
                            <!-- <div class="single__widget widget__bg">
                                ...
                                <ul class="widget__tagcloud">
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="shop.php"> Hair Care
                                    </a></li>
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="shop.php">Make Up</a></li>
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="shop.php">Skin Care</a></li>
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="shop.php">Styling </a></li>
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="shop.php">Products </a></li>
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="shop.php">Fairness</a></li>
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="shop.php">Cream Oil </a></li>
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="shop.php">Matte Walnut </a></li>
                                </ul>
                            </div> -->
                        </div>
                    </div>
                                        ...
                                        <div class="row mb--n30">
                                                ...
                                                <article class="product__card">
                                                    <div class="product__card--thumbnail">
                                                        <a class="product__card--thumbnail__link display-block" href="product-details.php">
                                                            <img class="product__card--thumbnail__img product__primary--img" src="assets/img/bracelet zip/GJBR02R1.jpg" alt="product-img">
                                                            <img class="product__card--thumbnail__img product__secondary--img" src="assets/img/bracelet zip/GJBR02R3.jpg" alt="product-img">
                                                        </a>
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-6 custom-col mb-30">
                                                <article class="product__card">
                                                    <div class="product__card--thumbnail">
                                                        <a class="product__card--thumbnail__link display-block" href="product-details.php">
                                                            <img class="product__card--thumbnail__img product__primary--img" src="assets/img/Gorga Jewels/GJR01R2.jpg" alt="product-img">
                                                            <img class="product__card--thumbnail__img product__secondary--img" src="assets/img/Gorga Jewels/GJR01R1.jpg" alt="product-img">
                                                        </a>
                                                        <ul class="product__card--action">
                                                            <!-- <li class="product__card--action__list">
                                                                <a class="product__card--action__btn" title="Quick View" data-bs-toggle="modal" data-bs-target="#examplemodal" href="javascript:void(0)">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-6 custom-col mb-30">
                                                <article class="product__card">
                                                    <div class="product__card--thumbnail">
                                                        <a class="product__card--thumbnail__link display-block" href="product-details.php">
                                                            <img class="product__card--thumbnail__img product__primary--img" src="assets/img/earrings zip/GJER01R3.jpg" alt="product-img">
                                                            <img class="product__card--thumbnail__img product__secondary--img" src="assets/img/earrings zip/GJER01R2.jpg" alt="product-img">
                                                        </a>
                                                        <span class="product__badge">-14%</span>
                                                        <ul class="product__card--action">
                                                            <!-- <li class="product__card--action__list">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-6 custom-col mb-30">
                                                <article class="product__card">
                                                    <div class="product__card--thumbnail">
                                                        <a class="product__card--thumbnail__link display-block" href="product-details.php">
                                                            <img class="product__card--thumbnail__img product__primary--img" src="assets/img/bracelet zip/GJBR03R1.jpg" alt="product-img">
                                                            <img class="product__card--thumbnail__img product__secondary--img" src="assets/img/bracelet zip/GJBR03R3.jpg" alt="product-img">
                                                        </a>
                                                        <ul class="product__card--action">
                                                            <!-- <li class="product__card--action__list">
                                                                <a class="product__card--action__btn" title="Quick View" data-bs-toggle="modal" data-bs-target="#examplemodal" href="javascript:void(0)">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-6 custom-col mb-30">
                                                <article class="product__card">
                                                    <div class="product__card--thumbnail">
                                                        <a class="product__card--thumbnail__link display-block" href="product-details.php">
                                                            <img class="product__card--thumbnail__img product__primary--img" src="assets/img/Gorga Jewels/GJR05R2.jpg" alt="product-img">
                                                            <img class="product__card--thumbnail__img product__secondary--img" src="assets/img/Gorga Jewels/GJR05R1.jpg" alt="product-img">
                                                        </a>
                                                        <ul class="product__card--action">
                                                            <!-- <li class="product__card--action__list">
                                                                <a class="product__card--action__btn" title="Quick View" data-bs-toggle="modal" data-bs-target="#examplemodal" href="javascript:void(0)">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-6 custom-col mb-30">
                                                <article class="product__card">
                                                    <div class="product__card--thumbnail">
                                                        <a class="product__card--thumbnail__link display-block" href="product-details.php">
                                                            <img class="product__card--thumbnail__img product__primary--img" src="assets/img/earrings zip/GJER03R3.jpg" alt="product-img">
                                                            <img class="product__card--thumbnail__img product__secondary--img" src="assets/img/earrings zip/GJER03R2.jpg" alt="product-img">
                                                        </a>
                                                        <span class="product__badge">-14%</span>
                                                        <ul class="product__card--action">
                                                            <!-- <li class="product__card--action__list">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-6 custom-col mb-30">
                                                <article class="product__card">
                                                    <div class="product__card--thumbnail">
                                                        <a class="product__card--thumbnail__link display-block" href="product-details.php">
                                                            <img class="product__card--thumbnail__img product__primary--img" src="assets/img/pendants zip/GJP02R1.jpg" alt="product-img">
                                                            <img class="product__card--thumbnail__img product__secondary--img" src="assets/img/pendants zip/GJP02R2.jpg" alt="product-img">
                                                        </a>
                                                        <span class="product__badge">-14%</span>
                                                        <ul class="product__card--action">
                                                            <!-- <li class="product__card--action__list">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-6 custom-col mb-30">
                                                <article class="product__card">
                                                    <div class="product__card--thumbnail">
                                                        <a class="product__card--thumbnail__link display-block" href="product-details.php">
                                                            <img class="product__card--thumbnail__img product__primary--img" src="assets/img/Gorga Jewels/GJR09R2.jpg" alt="product-img">
                                                            <img class="product__card--thumbnail__img product__secondary--img" src="assets/img/Gorga Jewels/GJR09R1.jpg" alt="product-img">
                                                        </a>
                                                        <ul class="product__card--action">
                                                            <!-- <li class="product__card--action__list">
                                                                <a class="product__card--action__btn" title="Quick View" data-bs-toggle="modal" data-bs-target="#examplemodal" href="javascript:void(0)">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-6 custom-col mb-30">
                                                <article class="product__card">
                                                    <div class="product__card--thumbnail">
                                                        <a class="product__card--thumbnail__link display-block" href="product-details.php">
                                                            <img class="product__card--thumbnail__img product__primary--img" src="assets/img/earrings zip/GJER04R3.jpg" alt="product-img">
                                                            <img class="product__card--thumbnail__img product__secondary--img" src="assets/img/earrings zip/GJER04R2.jpg" alt="product-img">
                                                        </a>
                                                        <ul class="product__card--action">
                                                            <!-- <li class="product__card--action__list">
                                                                <a class="product__card--action__btn" title="Quick View" data-bs-toggle="modal" data-bs-target="#examplemodal" href="javascript:void(0)">
