                                        ...
                                        <td class="cart__table--body__list">
                                            <div class="cart__product d-flex align-items-center">
                                                ...
                                                <div class="cart__thumbnail">
                                                    <a href="product-details.html"><img class="border-radius-5" src="assets/img/Gorga Jewels/GJR03R1.jpg" alt="cart-product"></a>
                                                </div>
                                                <div class="cart__content">
                                                    <h3 class="cart__content--title h4"><a href="product-details.html">Rings</a></h3>
                                                    <span class="cart__content--variant">COLOR: Gold</span>
                                    ...
                                    <tr class="cart__table--body__items">
                                        <td class="cart__table--body__list">
                                            <div class="cart__product d-flex align-items-center">
                                                ...
                                                <div class="cart__thumbnail">
                                                    <a href="product-details.html"><img class="border-radius-5" src="assets/img/pendants zip/GJP03R2.jpg" alt="cart-product"></a>
                                                </div>
                                                <div class="cart__content">
                                                    <h3 class="cart__content--title h4"><a href="product-details.html">Necklaces</a></h3>
                                                    <span class="cart__content--variant">COLOR: Silver</span>
                                                    <!-- <span class="cart__content--variant">WEIGHT: 2 Kg</span> -->
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr class="cart__table--body__items">
                                        <td class="cart__table--body__list">
                                            <div class="cart__product d-flex align-items-center">
                                                ...
                                                <div class="cart__thumbnail">
                                                    <a href="product-details.html"><img class="border-radius-5" src="assets/img/earrings zip/GJER03R3.jpg" alt="cart-product"></a>
                                                </div>
                                                <div class="cart__content">
                                                    <h3 class="cart__content--title h4"><a href="product-details.html">Earrings</a></h3>
                                                    <span class="cart__content--variant">COLOR: Rose Gold</span>
                                                    <!-- <span class="cart__content--variant">WEIGHT: 2 Kg</span> -->
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr class="cart__table--body__items">
                                        <td class="cart__table--body__list">
                                            <div class="cart__product d-flex align-items-center">
                                                ...
                                                <div class="cart__thumbnail">
                                                    <a href="product-details.html"><img class="border-radius-5" src="assets/img/bracelet zip/GJBR04R1.jpg" alt="cart-product"></a>
                                                </div>
                                                <div class="cart__content">
                                                    <h3 class="cart__content--title h4"><a href="product-details.html">Bracelets</a></h3>
                                                    <span class="cart__content--variant">COLOR: Gold</span>
                                                    <!-- <span class="cart__content--variant">WEIGHT: 2 Kg</span> -->
                                                </div>
                                            </div>
...
<!-- Mirrored from risingtheme.com/html/demo-becute/becute/wishlist.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Jul 2024 12:06:48 GMT -->
<!-- </html> -->
