<footer class="footer__section bg__black">
    <div class="container-fluid">
        <div class="main__footer d-flex justify-content-between">
            <div class="footer__widget footer__widget--width">
                ...
                <div class="footer__widget--inner">
                    <p class="footer__widget--desc text-ofwhite mb-20">Welcome to Viksun, where we celebrate the essence of <br> everyday life and the magic of endless possibilities.<br> Our philosophy revolves around you and only you,<br> embodying the spirit of self-confidence, style, and carefree attitude.</p>
            ...
            <div class="footer__widget--menu__wrapper d-flex footer__widget--width">
                <div class="footer__widget">
                    ...
                    <ul class="footer__widget--menu footer__widget--inner">
                        <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{route('dashboard')}}">My Account</a></li>
                        ...
                        <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{url('logout')}}">Checkout</a></li>
                        <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{url('wishlists')}}">Wishlist</a></li>
                         <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{url('https://viksun-lifestyle.com/privacy-policy')}}">Privacy Policy</a></li>
                         <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{url('https://viksun-lifestyle.com/terms')}}">Term Conditions</a></li>
                         <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{url('https://viksun-lifestyle.com/return-policy')}}">Return Policy</a></li>
                         <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{url('https://viksun-lifestyle.com/shipping-Policy')}}">shipping Policy</a></li>
                    </ul>
                </div>
                <div class="footer__widget">
                    ...
                    <ul class="footer__widget--menu footer__widget--inner">
                        ...
                        @foreach (\App\Models\Category::orderBy('order_level', 'desc')->where('level', 0)->orderBy('order_level', 'desc')->get()->take(3) as $key => $category)
            ...
            <div class="footer__widget footer__widget--width">
                ...
                <div class="footer__widget--inner">
                    <p class="footer__widget--desc text-ofwhite m-0">Subscribe now to receive the latest updates, exclusive offers, and more</p> 
                    <div class="newsletter__subscribe">
                        <form class="newsletter__subscribe--form" action="{{route('subscribers.store')}}" method="post">
                            @csrf
                            <label>
                                <input class="newsletter__subscribe--input" placeholder="Email Address" name="email" type="email" required>
                            </label>
                            <button class="newsletter__subscribe--button"type="submit" style="background-color:black;">Subscribe</button>
                        </form>   
                    </div> 
                </div> 
            </div>
        ...
        <div class="footer__bottom d-flex justify-content-between align-items-center">
            <p class="copyright__content text-ofwhite m-0">Copyright © 2024  . All Rights Reserved. Develop by  <a href="https://digigrowinfotech.com/">Digi Grow Infotech</a> </p>
