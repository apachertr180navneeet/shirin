...
<link rel="stylesheet" href="{{ static_asset('public/assets/css/custom-style.css') }}">

  <!-- ======= All CSS Plugins here ======== -->
   <link rel="stylesheet" href="{{static_asset('public/assets/webtheme/assets/css/plugins/swiper-bundle.min.css')}}">
   <link rel="stylesheet" href="{{static_asset('public/assets/webtheme/assets/css/plugins/glightbox.min.css')}}">
   <link href="https://fonts.googleapis.com/css2?family=Jost:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,300;1,400;1,500;1,600;1,700;1,800;1,900&amp;display=swap" rel="stylesheet">

   <!-- Plugin css -->
   <!--<link rel="stylesheet" href="{{static_asset('public/assets/webtheme/assets/css/vendor/bootstrap.min.css')}}">-->

   <!-- Custom Style CSS -->
   <link rel="stylesheet" href="{{static_asset('public/assets/webtheme/assets/css/style.css')}}">
   <link rel="stylesheet" href="{{static_asset('public/assets/webtheme/user/assets/css/style.css')}}">
 
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/metismenu@3.0.7/dist/metisMenu.min.css">
  <style>
.product__items--img {
    display: block;
    width: 100%;
...
<body>
    ...
    <!-- Page Loader -->
    <div id="page-loader" style="position:fixed;top:0;left:0;width:100%;height:100%;z-index:99999;background:#fff;display:flex;align-items:center;justify-content:center;transition:opacity 0.5s ease;">
        <div style="text-align:center;">
            <div style="width:50px;height:50px;border:4px solid #f3f3f3;border-top:4px solid {{ get_setting('base_color', '#d43533') }};border-radius:50%;animation:spin 0.8s linear infinite;margin:0 auto 15px;"></div>
            <div style="color:#666;font-size:14px;font-weight:500;">Loading...</div>
        </div>
    </div>
    <style>
    ...
    <script>
        window.addEventListener('load', function(){ document.getElementById('page-loader').classList.add('hide'); });
    </script>
    <!-- End Page Loader -->
...
<div class="modal fade" id="addToCart">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-zoom product-modal" id="modal-size" role="document">
        <div class="modal-content position-relative">
            ...
            <button type="button" class="close absolute-top-right btn-icon close z-1 btn-circle bg-gray mr-2 mt-2 d-flex justify-content-center align-items-center" data-dismiss="modal" style="background: #ededf2; width: calc(2rem + 2px); height: calc(2rem + 2px);">
      ...
      $('.modal').modal('hide');
           ...
           function updateNavCart(view,count){
            ...
            function removeFromCart(key){
                console.log('Removing cart item ID:', key);
...
<script type="text/javascript">
    ...
    if (input && typeof intlTelInput !== 'undefined' && window.intlTelInputGlobals) {
...
@endphp
    ...
    <!-- Scroll top bar -->
    <button id="scroll__top" style="background-color:black;"><svg xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="48" d="M112 244l144-144 144 144M256 120v292"/></svg></button>
    
  
</body>

<!-- All Script JS Plugins here  -->
<script src="{{static_asset('public/assets/webtheme/assets/js/vendor/popper.js')}}" defer="defer"></script>
<script src="{{static_asset('public/assets/webtheme/assets/js/vendor/bootstrap.min.js')}}" defer="defer"></script>
<script src="{{static_asset('public/assets/webtheme/assets/js/plugins/swiper-bundle.min.js')}}"></script>
<script src="{{static_asset('public/assets/webtheme/assets/js/plugins/glightbox.min.js')}}"></script>

<!-- Customscript js -->
<script src="{{static_asset('public/assets/webtheme/assets/js/script.js')}}"></script>

<!-- Mirrored from risingtheme.com/html/demo-suruchi-v1/suruchi/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 26 Oct 2023 07:05:29 GMT -->
</html>
