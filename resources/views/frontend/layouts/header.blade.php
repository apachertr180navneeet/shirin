...
<header class="header__section">
    ...
    <div class="header__topbar bg__secondary" style="background-color: black;">
        <div class="container-fluid">
            <div class="header__topbar--inner d-flex align-items-center justify-content-between">
                <marquee>
                <div class="header__shipping">
                    <ul class="header__shipping--wrapper d-flex">
                        <li class="header__shipping--text text-white">Welcome to Viksun online Store</li>
                        <li class="header__shipping--text text-white d-sm-2-none"><img class="header__shipping--text__icon" src="{{static_asset('public/assets/webtheme/assets/img/icon/bus.png')}}" alt="bus-icon"> Track Your Order</li>
                        <li class="header__shipping--text text-white d-sm-2-none"><img class="header__shipping--text__icon" src="{{static_asset('public/assets/webtheme/assets/img/icon/email.png')}}" alt="email-icon"> <a class="header__shipping--text__link" href="mailto:sainilaxmikant007@gmail.com">sainilaxmikant007@gmail.com</a></li>
                    </ul>
                </div>
            </marquee>
                    ...
                    <ul class="d-flex align-items-center">
                        <li class="language__currency--list">
                            <a class="language__switcher text-white" href="#">
                                <img class="language__switcher--icon__img" src="{{static_asset('public/assets/webtheme/assets/img/icon/language-icon.png')}}" alt="currency">
                                <span>English</span> 
        ...
        <div class="container-fluid">
            <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                ...
                <div class="main__logo">
                    <h1 class="main__logo--title"><a class="main__logo--link" href="{{route('home')}}"><img class="main__logo--img" src="{{ uploaded_asset(get_setting('system_logo_white')) }}" alt="{{ get_setting('site_name') }}" style="height: 87px; "></a></h1>
                </div>
                @endif
                <div class="header__search--widget header__sticky--none d-none d-lg-block">
                    <form class="d-flex header__search--form" id="header-search" action="{{ route('search') }}" method="get">
                    
                  
                        <div class="header__select--categories select">
                           
                           <!-- <select class="header__select--inner">-->
                           <!--     <option selected value="">All Categorys</option>-->
                           <!--     @foreach (\App\Models\Category::where('level', 0)->orderBy('order_level', 'desc')->get()->take(10) as $key => $category)-->
                             
                           <!--<option  value="{{ route('products.category', $category->slug) }}"> <a href="{{ route('products.category', $category->slug) }}">{{ $category->getTranslation('name') }}</a></option>-->
                           <!--  @endforeach-->
                           <!-- </select>-->
                           <select name="forma" class="header__select--inner">
    <option selected value=""> All Categories</option>
    @foreach (\App\Models\Category::where('level', 0)->orderBy('order_level', 'desc')->get()->take(10) as $key => $category)
        <option value="{{ route('products.category', $category->slug) }}">{{ $category->getTranslation('name') }}</option>
    @endforeach
</select>
<script>
    const selectElement = document.querySelector('.header__select--inner');
            ...
            window.location.href = selectedValue;
                        ...
                        <div class="header__search--box">
                            ...
                            <label>
                                ...
                                <input class="header__search--input" id="search"  name="keyword"   placeholder="Keyword here..." type="text" @isset($query)
                                value="{{ $query }}"
                            @endisset />
                            </label>
                            <button class="header__search--button bg__secondary text-white" type="submit" aria-label="search button" style="background-color: #556fbd; border-color: #556fbd;">
                    ...
                    <nav class="header__menu--navigation">
                        <ul class="d-flex">
                            <li class="header__menu--items style2">
                              ...
                              <li class="header__menu--items style2">
                                <a class="header__menu--link" href="{{route('search')}}">SHOP
                                 </a>
                             </li>
                            <li class="header__menu--items style2">
                                <a class="header__menu--link" href="{{route('about')}}">ABOUT US </a>  
                            </li>
                            @foreach (\App\Models\Category::orderBy('order_level', 'desc')->where('level', 0)->orderBy('order_level', 'desc')->get()->take(4) as $key => $category)
                            <li class="header__menu--items mega__menu--items style2">
                                <a class="header__menu--link" href="{{ route('products.category', $category->slug) }}">{{ $category->getTranslation('name') }} 
                ...
                <div class="header__account header__account2 header__sticky--block">
                    <ul class="d-flex">
                        <li class="header__account--items header__account2--items  header__account--search__items d-none d-lg-block">
                            <a class="header__account--btn search__open--btn" href="#"  data-bs-toggle="offcanvas" data-bs-target="#search-drawer" data-offcanvas>
            ...
            <nav class="offcanvas__menu">
                <ul class="offcanvas__menu_ul">
                    ...
                    <li class="offcanvas__menu_li">
                        ...
                        <a class="offcanvas__menu_item" href="{{ route('products.category', $category->slug) }}">{{ $category->getTranslation('name') }} </a>
                        @endforeach
                     </ul>
                    </li>
    ...
    <div class="offcanvas__stikcy--toolbar">
        <ul class="d-flex justify-content-between">
            ...
            <li class="offcanvas__stikcy--toolbar__list">
                ...
                <a class="offcanvas__stikcy--toolbar__btn" href="{{url('search')}}">
                <span class="offcanvas__stikcy--toolbar__icon"> 
            ...
            <li class="offcanvas__stikcy--toolbar__list">
                <a class="offcanvas__stikcy--toolbar__btn" href="{{url('wishlists')}}">
                    <span class="offcanvas__stikcy--toolbar__icon"> 
    ...
    <div class="offCanvas__minicart">
        <div class="minicart__header ">
            <div class="minicart__header--top d-flex justify-content-between align-items-center">
                <h2 class="minicart__title h3"> SHOPING CART</h2>
    ...
    <div class="predictive__search--box ">
        <div class="predictive__search--box__inner">
            ...
            <form class="predictive__search--form" action="{{ route('search') }}" method="get" id="header-search">
               
                <label>
                    {{-- <input class="predictive__search--input" id="search" name="keyword" placeholder="Search Here" type="text" @isset($query)
                    value="{{ $query }}"
                @endisset /> --}}
                <input type="text" id="search" name="keyword" class="predictive__search--input" placeholder="Search for products..." @isset($query)
                value="{{ $query }}"
            @endisset />
                </label>
