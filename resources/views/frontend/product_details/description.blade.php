<div class="single__widget widget__bg bg-white mb-4 border p-3 p-sm-4">
    <!-- Tabs -->
    <div class="nav aiz-nav-tabs widget__title ">
        <a href="#tab_default_1" data-toggle="tab"
            class="mr-5 pb-2 fs-16 fw-700 text-reset active show" style="border-bottom: none;">{{ translate('Description') }}</a>
