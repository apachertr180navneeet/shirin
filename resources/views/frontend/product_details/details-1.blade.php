<div class="product__details--info">
    <form action="#">
        ...
        <p class="product__details--info__desc mb-15">{{ strip_tags($detailedProduct->getTranslation('description')) }}</p>
        <div class="product__variant">
                ...
                <fieldset class="variant__input--fieldset">
                    ...
                    <ul class="variant__size d-flex">
                        ...
                        <li class="variant__size--list">
                            ...
                            <label class="variant__attribute--value" for="attr-{{ $choice->attribute_id }}-{{ $key }}">
                                {{ $value }}
                            </label>
                        </li>
                        @endforeach
            ...
            <div class="product__variant--list quantity d-flex align-items-center mb-20">
                ...
                <button class="primary__btn quickview__cart--btn add-to-cart"
                        type="button"
                        onclick="addToCart()">
            ...
            <div class="product__variant--list mb-20">
                ...
                <button class="variant__buy--now__btn primary__btn buy-now add-to-cart"
                        type="button"
                        onclick="buyNow()">
                    {{ translate('Buy Now') }}
                </button>
