                        ...
                        <div class="product__details--info">
                            <form action="#">
                                        ...
                                        <fieldset class="variant__input--fieldset">
                                            ...
                                            <div class="variant__color d-flex">
                                                <div class="variant__color--list">
                                                    ...
                                                    <label class="variant__color--value red" for="color-red5" title="Red"><img class="variant__color--value__img" src="{{static_asset('public/assets/webtheme/user/assets/img/product/small-product/product1.webp')}}" alt="variant-color-img"></label>
                                                </div>
                                                <div class="variant__color--list">
                                                    <input id="color-red6" name="color" type="radio">
                                                    <label class="variant__color--value red" for="color-red6" title="Black"><img class="variant__color--value__img" src="{{static_asset('public/assets/webtheme/user/assets/img/product/small-product/product2.webp')}}" alt="variant-color-img"></label>
                                                </div>
                                                <div class="variant__color--list">
                                                    <input id="color-red7" name="color" type="radio">
                                                    <label class="variant__color--value red" for="color-red7" title="Pink"><img class="variant__color--value__img" src="{{static_asset('public/assets/webtheme/user/assets/img/product/small-product/product3.webp')}}" alt="variant-color-img"></label>
                                                </div>
                                                <div class="variant__color--list">
                                                    <input id="color-red8" name="color" type="radio">
                                                    <label class="variant__color--value red" for="color-red8" title="Orange"><img class="variant__color--value__img" src="{{static_asset('public/assets/webtheme/user/assets/img/product/small-product/product4.webp')}}" alt="variant-color-img"></label>
                                                </div>
                                            </div>
                                        </fieldset>
                                    </div>
                                ...
                                <div class="guarantee__safe--checkout mb-30">
                                    ...
                                    <img class="guarantee__safe--checkout__img" src="{{static_asset('public/assets/webtheme/user/assets/img/other/safe-checkout.webp')}}" alt="Payment Image">
                                </div>
                    ...
                    <div class="swiper-wrapper">
                            ...
                            <article class="product__card">
                                <div class="product__card--thumbnail">
                                    <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                        <img class="product__card--thumbnail__img product__primary--img" src="{{static_asset('public/assets/webtheme/user/assets/img/product/main-product/product1.webp')}}" alt="product-img">
                        ...
                        <div class="swiper-slide">
                            <article class="product__card">
                                <div class="product__card--thumbnail">
                                    <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                        <img class="product__card--thumbnail__img product__primary--img" src="{{static_asset('public/assets/webtheme/user/assets/img/product/main-product/product4.webp')}}" alt="product-img">
                                        <img class="product__card--thumbnail__img product__secondary--img" src="{{static_asset('public/assets/webtheme/user/assets/img/product/main-product/product3.webp')}}" alt="product-img">
                                    </a>
                                    <ul class="product__card--action">
                                        <li class="product__card--action__list">
                                            <a class="product__card--action__btn" title="Quick View" data-bs-toggle="modal" data-bs-target="#examplemodal" href="javascript:void(0)">
                        ...
                        <div class="swiper-slide">
                            <article class="product__card">
                                <div class="product__card--thumbnail">
                                    <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                        <img class="product__card--thumbnail__img product__primary--img" src="{{static_asset('public/assets/webtheme/user/assets/img/product/main-product/product6.webp')}}" alt="product-img">
                                        <img class="product__card--thumbnail__img product__secondary--img" src="{{static_asset('public/assets/webtheme/user/assets/img/product/main-product/product5.webp')}}" alt="product-img">
                                    </a>
                                    <span class="product__badge">-14%</span>
                                    <ul class="product__card--action">
                                        <li class="product__card--action__list">
                        ...
                        <div class="swiper-slide">
                            <article class="product__card">
                                <div class="product__card--thumbnail">
                                    <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                        <img class="product__card--thumbnail__img product__primary--img" src="{{static_asset('public/assets/webtheme/user/assets/img/product/main-product/product2.webp')}}" alt="product-img">
                                        <img class="product__card--thumbnail__img product__secondary--img" src="{{static_asset('public/assets/webtheme/user/assets/img/product/main-product/product1.webp')}}" alt="product-img">
                                    </a>
                                    <ul class="product__card--action">
                                        <li class="product__card--action__list">
                                            <a class="product__card--action__btn" title="Quick View" data-bs-toggle="modal" data-bs-target="#examplemodal" href="javascript:void(0)">
                        ...
                        <div class="swiper-slide">
                            <article class="product__card">
                                <div class="product__card--thumbnail">
                                    <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                        <img class="product__card--thumbnail__img product__primary--img" src="{{static_asset('public/assets/webtheme/user/assets/img/product/main-product/product8.webp')}}" alt="product-img">
                                        <img class="product__card--thumbnail__img product__secondary--img" src="{{static_asset('public/assets/webtheme/user/assets/img/product/main-product/product7.webp')}}" alt="product-img">
                                    </a>
                                    <span class="product__badge">-14%</span>
                                    <ul class="product__card--action">
                                        <li class="product__card--action__list">
