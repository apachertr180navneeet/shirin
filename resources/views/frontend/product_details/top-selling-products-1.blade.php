        ...
        <div class="shop__sidebar--product">
            ...
            <div class="small__product--card d-flex">
                <div class="small__product--thumbnail">
                    <a class="display-block" href="{{ route('product', $top_product->slug) }}"><img src="{{static_asset('public/assets/webtheme/user/assets/img/product/small-product/product1.webp')}}" alt="product-img"></a>
                </div>
