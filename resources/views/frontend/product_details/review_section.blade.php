<div class="single__widget widget__bg bg-white border mb-4">
    <div class="p-3 p-sm-4">
        <h3 class="widget__title fs-16 fw-700 mb-0">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4 text-right">
                    <a  href="javascript:void(0);" onclick="product_review('{{ $detailedProduct->id }}')" 
                        class="primary__btn btn btn-warning fw-400 rounded-5 text-white">
