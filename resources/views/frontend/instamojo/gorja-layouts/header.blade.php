                ...
                <div class="header__topbar--inner style6 d-flex align-items-center justify-content-between">
                    <ul class="header__topbar--info d-none d-lg-flex">
                        ...
                        <li class="header__info--text text-white">
                            ...
                            <a  href="tel:919829094366">: +91-9829094366</a>
                        </li>
                    </ul>
                    <div class="header__top--right d-flex align-items-center">
                        ...
                        <ul class="header__top--link d-flex align-items-center">
                            ...
                            <li class="header__link--menu"><a class="header__link--menu__text" href="compare.php">
                ...
                <div class="main__header--inner d-flex justify-content-between align-items-center">
                    ...
                    <div class="main__logo">
                        <h1 class="main__logo--title"><a class="main__logo--link" href="index.php">
                            <img style="width: 100px;" class="main__logo--img" src="{{asset('user/assets/img/logos/LOGO GOLD.png')}}" alt="logo-img">
                        </a></h1>
                    </div>
                        ...
                        <nav class="header__menu--navigation">
                            <ul class="header__menu--wrapper d-flex">
                                ...
                                <li class="header__menu--items mega__menu--items">
                                    <a class="header__menu--link" href="shop.php">All Jewellery
                                        <!-- <svg class="menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12" height="7.41" viewBox="0 0 12 7.41">
                                            <path  d="M16.59,8.59,12,13.17,7.41,8.59,6,10l6,6,6-6Z" transform="translate(-6 -8.59)" fill="currentColor" opacity="0.7"/>
                                        </svg> -->
                                    </a>
                                ...
                                <li class="header__menu--items">
                                    ...
                                    <ul class="header__sub--menu">
                                        <li class="header__sub--menu__items"><a href="#" class="header__sub--menu__link">Rings</a></li>
                                        <li class="header__sub--menu__items"><a href="#" class="header__sub--menu__link">Earings</a></li>
                                        <li class="header__sub--menu__items"><a href="#" class="header__sub--menu__link">Jewellery</a></li>
                                    </ul>
                                </li>
                                <li class="header__menu--items">
                                ...
                                <li class="header__menu--items">
                                    <a class="header__menu--link" href="about.php">About
                                        <!-- <svg class="menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12" height="7.41" viewBox="0 0 12 7.41">
                                            <path  d="M16.59,8.59,12,13.17,7.41,8.59,6,10l6,6,6-6Z" transform="translate(-6 -8.59)" fill="currentColor" opacity="0.7"/>
                                        </svg> -->
                                         <!-- <ul class="header__sub--menu">
                    ...
                    <div class="header__account">
                        <ul class="header__account--wrapper d-flex align-items-center">
                            ...
                            <li class="header__account--items">
                                <a class="header__account--btn d-sm-2-none" href="login.php">
                                    <span class="header__account--btn__icon">
                                        <!-- <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M2.09836 2.28681C1.75014 2.69477 1.47391 3.1791 1.28545 3.71213C1.097 4.24516 1 4.81646 1 5.39341C1 5.97036 1.097 6.54167 1.28545 7.0747C1.47391 7.60773 1.75014 8.09206 2.09836 8.50002L8.50001 16L14.9016 8.50002C15.6049 7.6761 16 6.55862 16 5.39341C16 4.22821 15.6049 3.11073 14.9016 2.28681C14.1984 1.46289 13.2446 1.00001 12.25 1.00001C11.2554 1.00001 10.3016 1.46289 9.59833 2.28681L8.50001 3.57358L7.40168 2.28681C7.05346 1.87884 6.64006 1.55522 6.18509 1.33443C5.73011 1.11364 5.24248 1 4.75002 1C4.25756 1 3.76992 1.11364 3.31495 1.33443C2.85998 1.55522 2.44658 1.87884 2.09836 2.28681V2.28681Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg> -->
                                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currenColor" class="bi bi-box-arrow-in-right" viewBox="0 0 17 17">
            ...
            <div class="offcanvas__inner">
                <div class="offcanvas__logo">
                    <a class="offcanvas__logo_link" href="index.php">
                        <img src="LOGO GOLD.png" alt="Logo-img" width="158" height="36">
                    </a>
                    ...
                    <ul class="offcanvas__menu_ul">
                        ...
                        <li class="offcanvas__menu_li">
                         ...
                         <li class="offcanvas__menu_li">
                            ...
                            <ul class="offcanvas__sub_menu">
                                <li class="offcanvas__sub_menu_li"><a href="#" class="offcanvas__sub_menu_item">Rings</a></li>
                                <li class="offcanvas__sub_menu_li"><a href="contact.html" class="offcanvas__sub_menu_item">Earingss</a></li>
                                <li class="offcanvas__sub_menu_li"><a href="cart.html" class="offcanvas__sub_menu_item">Other Jewellery</a></li>
            ...
            <div class="minicart__product">
                <div class="minicart__product--items d-flex">
                    <div class="minicart__thumb">
                        <a href="product-details.php"><img src="assets/img/Gorga Jewels/GJR05R1.jpg" alt="prduct-img"></a>
                    </div>
                ...
                <div class="minicart__product--items d-flex">
                    <div class="minicart__thumb">
                        <a href="product-details.php"><img src="assets/img/pendants zip/GJP02R2.jpg" alt="prduct-img"></a>
                    </div>
                    <div class="minicart__text">
                        <h4 class="minicart__subtitle"><a href="product-details.html">Necklaces
                           </a></h4>
