                            ...
                            <div class="footer__widget--inner">
                                <div class="footer__logo">
                                    <a class="footer__logo--link" href="index.php">
                                        <img class="footer__logo--img" src="{{asset('user/assets/img/logos/LOGO PINK.png')}}" alt="logo-img" width="100px">
                                    </a>
                                </div>
                                ...
                                <ul class="footer__widget--info">
                                    <li class="footer__widget--info_list">
                                        ...
                                        <span class="footer__widget--info__text">210 VASUNDHARA COLONY, TONK ROAD, JAIPUR PIN 302018
                                            LAND MARK
                                            JAIN MANDIR WALI GALI</span>
                                    </li>
                                    <li class="footer__widget--info_list">
                                        ...
                                        <a class="footer__widget--info__text" href="#tel:9829094366">: +91 9829094366</a>
                                    </li>
                                    <li class="footer__widget--info_list">
                                        ...
                                        <a class="footer__widget--info__text" href="#mailto:info@gorjajewels.com">info@gorjajewels.com</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-2 col-md-5">
                        <div class="footer__widget">
                            ...
                            <ul class="footer__widget--menu footer__widget--inner">
                                ...
                                <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="#">Shipping Policy</a></li>
                                <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="#">Privacy Policy</a></li>
                                <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="#">Refund/ Exchange/Return Policy</a></li>
                                <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="#">Terms and Conditions</a></li>
                                <!-- <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="checkout.php">Checkout</a></li> -->
                            </ul>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="footer__bottom--inenr d-flex justify-content-between align-items-center">
                    <p class="copyright__content mb-0">
                        <span class="text__secondary"> Copyright 2024</span>
                    ...
                    <div class="footer__payment">
                        <img src="{{asset('user/assets/img/icon/payment-img.webp')}}" alt="payment-img">
                    </div>
                </div>
            </div>
        </div>
