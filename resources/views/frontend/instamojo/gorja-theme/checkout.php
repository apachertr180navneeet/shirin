                                    ...
                                    <tbody class="cart__table--body">
                                            ...
                                            <td class="cart__table--body__list">
                                                <div class="product__image two  d-flex align-items-center">
                                                    <div class="product__thumbnail border-radius-5">
                                                        <a class="display-block" href="product-details.php"><img class="display-block border-radius-5" src="assets/img/Gorga Jewels/GJR01R1.jpg" alt="cart-product"></a>
                                                        <span class="product__thumbnail--quantity">1</span>
                                                    </div>
                                                    <div class="product__description">
                                                        <h4 class="product__description--name"><a href="product-details.php">Rings</a></h4>
                                                        <span class="product__description--variant">COLOR: Gold</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="cart__table--body__list">
                                        ...
                                        <tr class="cart__table--body__items">
                                            <td class="cart__table--body__list">
                                                <div class="cart__product d-flex align-items-center">
                                                    <div class="product__thumbnail border-radius-5">
                                                        <a class="display-block" href="product-details.php"><img class="display-block border-radius-5" src="assets/img/pendants zip/GJP01R2.jpg" alt="cart-product"></a>
                                                        <span class="product__thumbnail--quantity">1</span>
                                                    </div>
                                                    <div class="product__description">
                                                        <h4 class="product__description--name"><a href="product-details.php">Necklaces</a></h4>
                                                        <span class="product__description--variant">COLOR: Silver</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="cart__table--body__list">
                                        ...
                                        <tr class="cart__table--body__items">
                                            <td class="cart__table--body__list">
                                                <div class="cart__product d-flex align-items-center">
                                                    <div class="product__thumbnail border-radius-5">
                                                        <a class="display-block" href="product-details.php"><img class="display-block border-radius-5" src="assets/img/earrings zip/GJER01R3.jpg" alt="cart-product"></a>
                                                        <span class="product__thumbnail--quantity">1</span>
                                                    </div>
                                                    <div class="product__description">
                                                        <h4 class="product__description--name"><a href="product-details.php">Earrings</a></h4>
                                                        <span class="product__description--variant">COLOR: Rose Gold</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="cart__table--body__list">
...
<!-- Mirrored from risingtheme.com/html/demo-becute/becute/checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Jul 2024 12:07:25 GMT -->
<!-- </html> -->
