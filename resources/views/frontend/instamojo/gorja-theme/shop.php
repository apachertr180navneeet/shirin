            ...
            <div class="container">
                ...
                <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="shop__collection--card text-center">
                                <a class="shop__collection--link" href="shop.php">
                                    <img class="shop__collection--img" src="assets/img/pendants zip/GJP01R1.jpg" alt="icon-img">
                        ...
                        <div class="swiper-slide">
                            <div class="shop__collection--card text-center">
                                <a class="shop__collection--link" href="shop.php">
                                    <img class="shop__collection--img" src="assets/img/bracelet zip/GJBR01R2.jpg" alt="icon-img">
                        ...
                        <div class="swiper-slide">
                            <div class="shop__collection--card text-center">
                                <a class="shop__collection--link" href="shop.php">
                                    <img class="shop__collection--img" src="assets\img\earrings zip\GJER01R3.jpg" alt="icon-img">
                        ...
                        <div class="swiper-slide">
                            <div class="shop__collection--card text-center">
                                <a class="shop__collection--link" href="shop.php">
                                    <img class="shop__collection--img" src="assets/img/Gorga Jewels/GJR03R1.jpg" alt="icon-img">
                        ...
                        <div class="swiper-slide">
                            <div class="shop__collection--card text-center">
                                <a class="shop__collection--link" href="shop.php">
                                    <img class="shop__collection--img" src="assets/img/earrings zip/GJER12R2.jpg" alt="icon-img">
                                    <h3 class="shop__collection--title mb-0">Earrings</h3>
                                </a>
                            </div>
                        </div>
