        ...
        <section class="portfolio__section section--padding">
            <div class="container">
                <div class="section__heading text-center mb-40">
                    <h2 class="section__heading--maintitle">Watch Our Gallery</h2>
                </div>
                @if($gallery_show->count() != 0)
                        ...
                        <div class="col mb-30">
                            <div class="portfolio__items">
                                <div class="portfolio__items--thumbnail position__relative">
                                    <a class="portfolio__items--thumbnail__link display-block glightbox" data-gallery="portfolio" href="{{ uploaded_asset($gallery->photo) }}"><img class="portfolio__items--thumbnail__img" src="{{ uploaded_asset($gallery->photo) }}" alt="portfolio-img">
                                        <div class="portfolio__view--icon bg-dark">
                ...
                @else 
                <div class="section__heading text-center mb-40">
                    <h3 class="section__heading--maintitle">Data Uploaded Coming Soon</h3>
                </div>
                @endif
            </div>
        </section>
