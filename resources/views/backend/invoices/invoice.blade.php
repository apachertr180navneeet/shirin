...
<body>
    <div>
        ...
        @php
		//dd($order);
            // TEMP: Disabled logo to test image cache corruption
            ...
            <table>
                <tr>
                    <td>
						...
						@else
							<img src="{{ static_asset('public/assets/img/logo.png') }}" height="30" style="display:inline-block;">
						@endif 
						--}}
                        <span style="font-weight:bold; font-size:1.2rem;">{{ get_setting('site_name') }}</span>
                    </td>
                        ...
                        @if ($orderDetail->product != null)
                            <tr class="">
                                <td>
                                    ...
                                    <small>
                                        @php
                                            $stock = $orderDetail->product->stocks
                                        ...
                                        @endphp
                                        {{ translate('SKU') }}: {{ $stock ? $stock->sku : 'N/A' }}
                                    </small>
                                </td>
                                <td>
