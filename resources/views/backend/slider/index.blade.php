...
<div class="aiz-titlebar text-left mt-2 mb-3">
	<div class="row align-items-center">
		...
		<div class="col-md-6 text-md-right">
			<a href="{{ route('adminslider.create') }}" class="btn btn-primary">
				<span>{{translate('Upload New Slider')}}</span>
			</a>
		</div>
	</div>
</div>
...
<div class="card">
    <form id="sort_uploads" action="">
        <div class="card-header row gutters-5">
            <div class="col-md-3">
                <h5 class="mb-0 h6">{{translate('All Slider')}}</h5>
            </div>
             <div class="col-md-9">
    				...
    				<div class="aiz-file-box">
    					<div class="dropdown-file" >
    						...
    						<div class="dropdown-menu dropdown-menu-right">
    							<a href="{{ route('adminslider.edit', $file->id) }}" class="dropdown-item">
    								<i class="las la-edit mr-2"></i>
    								<span>{{ translate('Edit') }}</span>
    							</a>
    							<a href="javascript:void(0)" class="dropdown-item confirm-alert" data-href="{{ route('slider.destroy', $file->id ) }}" data-target="#delete-modal">
    					...
    					<div class="card card-file aiz-uploader-select c-default">
    						...
    						@if($file->mobile_slider)
    							<div class="card-footer p-1 text-center border-top">
    								<img src="{{ uploaded_asset($file->mobile_slider)}}" class="img-fit mw-100" style="max-height:40px">
    								<span class="badge badge-info d-block mt-1">{{ translate('Mobile') }}</span>
    							</div>
    						@endif
    					</div>
    				</div>
