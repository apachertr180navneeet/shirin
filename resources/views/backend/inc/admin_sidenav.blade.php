    ...
    <div class="aiz-sidebar left c-scrollbar">
        <div class="aiz-side-nav-logo-wrap">
            <a href="{{ route('admin.dashboard') }}" class="d-block text-left">
                ...
                @else
                    <img class="mw-100" src="{{ static_asset('public/assets/img/logo.png') }}" class="brand-icon" alt="{{ get_setting('site_name') }}">
                @endif
            </a>
        </div>
           ...
           {{-- <div class="px-20px mb-3">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
               ...
               {{-- @if (addon_is_activated('delivery_boy'))
                ...
                <!-- Customers -->
                @canany(['view_all_customers','view_classified_products','view_classified_packages','view_all_contact'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @endcan
                            @can('view_all_contact')
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('contact.index') }}" class="aiz-side-nav-link">
             ...
             {{--   @canany(['view_all_seller','seller_payment_history','view_seller_payout_requests','seller_commission_configuration','view_all_seller_packages','seller_verification_form_configuration'])
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('adminslider.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['adminslider.create','adminslider.index','adminslider.edit'])}}">
                        <i class="las la-folder-open aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{ translate('Slider') }}</span>
                    </a>
                </li>
                <li class="aiz-side-nav-item">
                    <a href="{{ route('admingallery.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['adminsgallery.create','adminsgallery.index','adminsgallery.edit'])}}">
                        <i class="las la-folder-open aiz-side-nav-icon"></i>
            ...
            <!-- Website Setup -->
             @canany(['header_setup','footer_setup','view_all_website_pages','website_appearance'])
               ...
               @canany(['general_settings','features_activation','language_setup','currency_setup','vat_&_tax_setup',
                ...
                <!-- InstagramReels -->
                <li class="aiz-side-nav-item">
                    <a href="{{ route('insta-reels.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['insta-reels.index', 'insta-reels.create', 'insta-reels.edit'])}}">
                        <i class="las la-user-tie aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{translate('InstagramReels')}}</span>
                    </a>
                </li>

                <!-- CustomerShowcase  -->
                <li class="aiz-side-nav-item">
                    <a href="{{ route('customer_showcase.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['customer_showcase.create','customer_showcase.index','customer_showcase.edit'])}}">
                        <i class="las la-folder-open aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{ translate('Customer Showcase') }}</span>
                    </a>
                </li>

                <!-- Testimonials  -->
                <li class="aiz-side-nav-item">
                    <a href="{{ route('testimonial.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['testimonial.create','testimonial.index','testimonial.edit'])}}">
                        <i class="las la-folder-open aiz-side-nav-icon"></i>
                ...
                <!--Add Reviews -->
                <li class="aiz-side-nav-item">
                    <a href="{{ route('add_reviews.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['add_reviews.create','add_reviews.index','add_reviews.edit'])}}">
                        <i class="las la-folder-open aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{ translate('Add Reviews') }}</span>
                    </a>
                </li>
