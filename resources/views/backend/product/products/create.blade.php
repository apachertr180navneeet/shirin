            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row" id="category">
                            ...
                            <div class="col-md-8">
                                <select name="category_ids[]" class="form-control aiz-selectpicker" multiple data-live-search="true" required>
                                    @foreach($categories as $category)
                                        <option value="{{ $category->id }}"
                                         @if(isset($product) && $product->categories->contains('id', $category->id)) selected @endif>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label" for="signinSrEmail">{{translate('Video')}} <small>(300x300)</small></label>
                            <div class="col-md-8">
                                <div class="input-group" data-toggle="aizuploader" data-type="video">
                                    ...
                                    <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                    <input type="hidden" name="video_item" class="selected-files">
                                </div>
                                <div class="file-preview box sm">
                                </div>
                                <small class="text-muted">{{translate('This video is visible in only video box. Use 300x300 sizes video. Keep some blank space around main object of your video as we had to crop some edge in different devices to make it responsive.')}}</small>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{translate('Product Reviews & Rating')}}</h5>
                    </div>
                    <div class="card-body">
                        <div class="form-group row">
                            <label class="col-lg-3 col-from-label">{{translate('Rating')}}</label>
                            <div class="col-lg-8">
                                <div class="rating rating-input">
                                <label>
                                    <input type="radio" name="review_rating" value="1" required>
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-from-label">{{translate('Rating Counting')}}</label>
                            <div class="col-lg-8">
                                <input type="number" class="form-control" name="rating_counting" placeholder="{{ translate('Enter Rating Counting Number') }}">
                            </div>
                        </div>
                    </div>
                </div>
