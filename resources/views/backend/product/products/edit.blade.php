            ...
            <div class="col-lg-8">
                    ...
                    <ul class="nav nav-tabs nav-fill border-light">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-reset @if ($language->code == $lang) active @else bg-soft-dark border-light border-left-0 @endif py-3" href="{{ route('products.admin.edit', ['id'=>$product->id, 'lang'=> $language->code] ) }}">
                                <img src="{{ static_asset('public/assets/img/flags/'.$language->code.'.png') }}" height="11" class="mr-1">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label" for="signinSrEmail">{{translate('Video')}} <small>(290x300)</small></label>
                            <div class="col-md-8">
                                <div class="input-group" data-toggle="aizuploader" data-type="video">
                                    ...
                                    <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                    <input type="hidden" name="video_item" value="{{ $product->video_item }}" class="selected-files">
                                </div>
                                <div class="file-preview box sm">
                                </div>
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-lg-8">
                                ...
                                @for ($i = 1; $i <= 5; $i++)
                                    <label class="mr-2" style="cursor:pointer;">
                                        <input type="radio" name="review_rating" value="{{ $i }}" {{ $product->review_rating == $i ? 'checked' : '' }} hidden>
                                        <i class="las la-star {{ $product->review_rating >= $i ? 'active' : '' }}"></i>
                                    </label>
                                @endfor
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="number" class="form-control" name="rating_counting" value="{{ $product->rating_counting }}" placeholder="{{ translate('Enter Rating Counting Number') }}">
                            </div>
                        </div>
                    </div>
                </div>
